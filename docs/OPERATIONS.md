...
Эти времена сохранены только как предложение для просмотра. Live-входов сейчас нет, publish job жёстко выключен, а release имеет статус `FOR_REVIEW_DO_NOT_PUBLISH`.
...
Live-входов сейчас нет. Значения `15:20`, `15:40`, `16:00`, `16:20`, `16:40` — только предложенный порядок; они могут стать live-входами лишь после отдельного статуса `APPROVED_FOR_AUTOMATION`.
